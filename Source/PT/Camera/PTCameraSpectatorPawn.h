...
#include "PTCameraSpectatorPawn.generated.h"

/**
 * 
 */
UCLASS()
class PT_API APTCameraSpectatorPawn : public ASpectatorPawn
{
	GENERATED_BODY()
	public:

	APTCameraSpectatorPawn(const FObjectInitializer& ObjectInitializer);
